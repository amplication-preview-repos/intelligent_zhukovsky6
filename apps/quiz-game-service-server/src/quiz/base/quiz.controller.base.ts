...
export class QuizControllerBase {
  ...
  @common.Get("/:id/quizAttempts")
  @ApiNestedQuery(QuizAttemptFindManyArgs)
  async findQuizAttempts(
    @common.Req() request: Request,
    @common.Param() params: QuizWhereUniqueInput
  ): Promise<QuizAttempt[]> {
    const query = plainToClass(QuizAttemptFindManyArgs, request.query);
    const results = await this.service.findQuizAttempts(params.id, {
      ...query,
      select: {
        createdAt: true,
        id: true,
  ...
  @common.Post("/:id/quizAttempts")
  async connectQuizAttempts(
    @common.Param() params: QuizWhereUniqueInput,
    @common.Body() body: QuizAttemptWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      quizAttempts: {
        connect: body,
  ...
  @common.Delete("/:id/quizAttempts")
  async disconnectQuizAttempts(
    @common.Param() params: QuizWhereUniqueInput,
    @common.Body() body: QuizAttemptWhereUniqueInput[]
  ): Promise<void> {
    const data = {
